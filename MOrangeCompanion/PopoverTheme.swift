...
struct PopoverTheme {
    ...
    static let playful = PopoverTheme(
        name: "Peach",
        popoverBg: NSColor(red: 0.995, green: 0.978, blue: 0.95, alpha: 0.985),
        popoverBorder: NSColor(red: 0.95, green: 0.59, blue: 0.34, alpha: 0.95),
        popoverBorderWidth: 2.0,
        popoverCornerRadius: 26,
        titleBarBg: NSColor(red: 1.0, green: 0.86, blue: 0.74, alpha: 0.98),
        titleText: NSColor(red: 0.93, green: 0.36, blue: 0.05, alpha: 1.0),
        titleFont: .systemFont(ofSize: 14, weight: .heavy),
        titleFormat: .lowercaseTilde,
        separatorColor: NSColor(red: 0.95, green: 0.69, blue: 0.48, alpha: 0.28),
        font: .systemFont(ofSize: 13, weight: .regular),
        fontBold: .systemFont(ofSize: 13, weight: .semibold),
        textPrimary: NSColor(red: 0.22, green: 0.17, blue: 0.12, alpha: 1.0),
        textDim: NSColor(red: 0.54, green: 0.45, blue: 0.37, alpha: 1.0),
        accentColor: NSColor(red: 0.93, green: 0.41, blue: 0.08, alpha: 1.0),
        errorColor: NSColor(red: 0.9, green: 0.3, blue: 0.2, alpha: 1.0),
        successColor: NSColor(red: 0.31, green: 0.69, blue: 0.42, alpha: 1.0),
        inputBg: NSColor(red: 1.0, green: 0.995, blue: 0.985, alpha: 1.0),
        inputCornerRadius: 16,
        bubbleBg: NSColor(red: 1.0, green: 0.96, blue: 0.9, alpha: 0.97),
        bubbleBorder: NSColor(red: 0.95, green: 0.66, blue: 0.46, alpha: 0.7),
        bubbleText: NSColor(red: 0.49, green: 0.39, blue: 0.3, alpha: 1.0),
